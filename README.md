...
Algunos de los aspectos a analizar/considerar en el análisis:
...
Las Hipótesis preliminares a contrastar a través del análisis de los datos planteados son las siguientes:
